...
def userRegister():
	...
	SQL = "insert into user(fname,lname,email,phone,uname,password) values ('"+fname+"','"+lname+"','"+email+"','"+phone+"','"+uname+"','"+passw+"') "
	try:
		cursor.execute(SQL)
...
def userLogin():
	...
	uname = input("Enter User Name \t: ")
	passw = input("Enter Password \t : ")
	SQL = "select * from user where uname = '"+uname+"' and password = '"+passw+"' "
	print("\n\n",SQL,"\n\n")
